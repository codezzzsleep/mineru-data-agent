...
| Agent 子任务与工具选择 | 5 个离线回归案例输出 `agent_action_plan`、selected tools、replan triggers 和 `replan_after_quality` | `submission_artifacts/agent_decision_cases/README.md` |
...
| 失败/恢复负样本 | controlled fault-injection 覆盖 text cleanup、OCR retry 成功/失败、strict provenance failure 和 numeric mismatch | `submission_artifacts/failure_recovery_cases/README.md` |
