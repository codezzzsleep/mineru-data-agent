...
- LLM trace tool calls: 4
- Tool calls with token usage: 2
- Results with token usage: 1
- Prompt tokens: 2092
...
| --- | --- | ---: | --- | --- |
| submission_artifacts/llm_cases/case_llm_financial_review/result.json | completed | 2 | yes | no |
...
| --- | --- | --- | ---: | ---: |
| submission_artifacts/llm_cases/case_llm_financial_review/trace.json | modelscope-llm-preplan | completed | 1404 | None |
| submission_artifacts/llm_cases/case_llm_financial_review/trace.json | modelscope-llm | completed | 2905 | None |
