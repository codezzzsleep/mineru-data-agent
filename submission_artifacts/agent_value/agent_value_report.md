...
- With state machine: 10
- With task_result: 12
- With field evidence: 13
...
| `submission_artifacts/recovery_cases/case_pdf_llm_api_to_cli_fallback/result.json` | `llm_enabled_saved_result_without_live_trace` | `agent-api` | 0 | - | pass (100) | recovered_accept / cli_fallback | 0 | 2 |
