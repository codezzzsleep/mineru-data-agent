...
# MinerU Data Agent Run c759949d7acd
...
- Input: `<PROJECT_ROOT>\runs\failure_recovery_cases\_inputs\ocr_retry_failure_controlled.pdf`
...
- Anomaly signals: 0
- Retrieval chunks: 1
- Recovery decision: retry_or_manual_review
...
- Recovery attempt(s) failed but were kept in the audit trail: ocr_retry.
- Retry with OCR/VLM-capable parsing or inspect the source file quality.

Attempts:
- initial: pass_with_warnings (92/100), selected
- ocr_retry: failed (0/100), not selected

## Issues
- [warning] short_text: Extracted text is very short; the input may need OCR/VLM fallback.
