...
- `agent_live_cases`: `{"provider": "modelscope", "model": "Qwen/Qwen3-235B-A22B-Instruct-2507", "evidence_generation": "legacy_pre_skill_gate", "skill_gate_live_rerun_completed": false, "total_cases": 8, "tool_call_completed_cases": 4, "tool_validated_cases": 0, "answer_quality_pass_cases": 2, "answer_quality_questionable_cases": 2, "answer_quality_unreviewed_cases": 0, "live_evidence_cases": 4, "completed_status": 4, "failed_or_incomplete": 4, "total_tokens": 61890}`
- `cost_model`: `{"scenarios": 6, "pricing_inputs": {"gpu_cny_per_hour": 8.0, "mineru_api_cny_per_page": 0.15, "llm_input_cny_per_1m_tokens": 1.0, "llm_output_cny_per_1m_tokens": 2.0, "assumed_pages_per_pdf": 10, "notes": "Illustrative May 2026 scenario inputs for sensitivity analysis; replace with current provider quotes before production cost planning. ModelScope free-tier and competition GPU assumptions are quota/resource dependent."}, "live_evidence_available": true}`
