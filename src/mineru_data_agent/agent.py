...
from .recovery import (
    ...
    NATIVE_SUFFIXES,
    PPTX_SUFFIXES,
    apply_llm_quality_decision as _apply_llm_quality_decision,
    apply_strict_page_provenance as _apply_strict_page_provenance,
    attempt_summary as _attempt_summary,
    build_recovery_decision as _build_recovery_decision,
    build_runtime_recovery_plan as _build_runtime_recovery_plan,
    clean_text_artifacts as _clean_text_artifacts,
    failed_attempt_summary as _failed_attempt_summary,
    is_better_quality as _is_better_quality,
    mark_selected_attempt as _mark_selected_attempt,
    quality_issue_codes as _issue_codes,
    requires_page_provenance as _requires_page_provenance,
    runner_kind as _runner_kind,
    runtime_recovery_skip_reason as _runtime_recovery_skip_reason,
)
